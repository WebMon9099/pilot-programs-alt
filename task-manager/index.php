...
<head>
  ...
  <title>Task Manager (Legacy)</title>
...
<a href="#" onclick="window.open( '/user-guide/getting-started#using-on-smartphone-tablet', 'name', 'location=no,scrollbars=yes,status=no,toolbar=no,resizable=yes' )" target="”_blank”" rel="noopener"><div class="_button">Learn more about Compatibility</div></a>
  ...
  <div id="game">
    <div id="top">
      <div id="toptitle">
        <div>Task Manager <span>Legacy</span></div>
      </div>
      <div id="topright_container">
        <div id="topright_inner">
          <a href="#" onclick="window.open( '/user-guide/task-manager', 'name', 'location=no,scrollbars=yes,status=no,toolbar=no,resizable=yes' )" target="”_blank”" rel="noopener" class="help"></a>
    ...
    <div id="middle">
      <div class="screen on" id="logo-screen">
        <div id="subtitle">Task Manager</div>
        <button id="start-button" class="big start-button">
          Start Activity
        </button>
        <button id="userguide-button" class="big userguide-button" href="#" onclick="window.open( '/user-guide/task-manager', 'name', 'location=no,scrollbars=yes,status=no,toolbar=no,resizable=yes' )" target="”_blank”" rel="noopener">
          User Guide
        </button>
        <div class="bottom">
          <div id="loading">
      ...
      <div class="screen off" id="game-screen">
        <div id="play-time">
          ...
          <span class="action">input data</span>!
        </div>
        <div class="keyboard_bar">
          <div id="keyboard1" class="keyboard">
            <img src="images/key_0.png" alt="0" />
          </div>
          <div id="keyboard2" class="keyboard">
            <img src="images/key_0.png" alt="0" />
          </div>
        </div>
        ...
        <div id="notepad-autopilot">
          <div id="notepad">
            <div id="altitude"><span class="val"></span></div>
            <div id="heading"><span class="val"></span></div>
            <div id="speed"><span class="val"></span></div>
          </div>
          <div id="autopilot">
            <div id="a" class="list">
