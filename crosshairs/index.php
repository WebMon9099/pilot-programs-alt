	...
	<div id="game">
		<div id="top">
			<div id="toptitle">
				...
				<div class="logo-title">
					Crosshairs<span>Legacy</span>
				</div>
			</div>
			<div id="topright_container">
				<div id="topright_inner">
					<a href="#" onclick="window.open( '/user-guide/crosshairs', 'name', 'location=no,scrollbars=yes,status=no,toolbar=no,resizable=yes' )" target="”_blank”" rel="noopener" class="help"></a>
		...
		<div id="middle">
			...
			<div class="screen off" id="logo-screen">
				<div id="subtitle">Crosshairs</div>
				<button id="start-button" class="big start-button">Start Activity</button>
				<button id="userguide-button" class="big userguide-button" href="#" onclick="window.open( '/user-guide/crosshairs', 'name', 'location=no,scrollbars=yes,status=no,toolbar=no,resizable=yes' )" target="”_blank”" rel="noopener">User Guide</button>
			</div>
			<div class="screen off" id="time-screen">
				<div class="time-screen-title">Select your duration:</div>
				<ul id="time-buttons">
					<li><button class="big time-button" data-time="120">2 Minutes</button></li>
					<li><button class="big time-button" data-time="300">5 Minutes</button></li>
					<li><button class="big time-button" data-time="420">7 Minutes</button></li>
				</ul>
			</div>
			...
			<div class="screen off" id="crosshairs-screen">
				...
				<canvas id="test" width="1" height="1"></canvas>
			</div>
				...
				<div id="result-container">
					...
					<div class="result-content">
						...
						<div class="result-values">
							...
							<div>
								<div class="result-type">Correct Observations</div>
								<div id="results">
									<span id="corrects">3</span><span id="total">4</span>
								</div>
							</div>
						</div>
					</div>
