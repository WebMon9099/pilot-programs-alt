...
<head>
    <title>Flight Director (Legacy)</title>
...
<a href="#" onclick="window.open( '/user-guide/getting-started#using-on-smartphone-tablet', 'name', 'location=no,scrollbars=yes,status=no,toolbar=no,resizable=yes' )" target="”_blank”" rel="noopener"><div class="_button">Learn more about Compatibility</div></a>
    ...
    <div id="title">
        ...
        <div id="tsider"></div>
        <div id="tsidery">
            <a href="#" onclick="window.open( '/user-guide/flight-director', 'name', 'location=no,scrollbars=yes,status=no,toolbar=no,resizable=yes' )" target="”_blank”" rel="noopener" class="help"></a>
    ...
    <div id="mainb">
        ...
        <div class="screen off" id="logo-screen">
            <div id="subtitle">Flight Director</div>
            <div>
            ...
            <button id="userguide-button" class="big userguide-button" href="#" onclick="window.open( '/user-guide/flight-director', 'name', 'location=no,scrollbars=yes,status=no,toolbar=no,resizable=yes' )" target="”_blank”" rel="noopener">
                User Guide
            </button>
        </div>
        <div class="screen off" id="time-screen">
            ...
            <ul id="time-buttons">
                <li>
                    <button class="big time-button" data-time="120">
                        2 Minutes
                    </button>
                </li>
                <li>
                    <button class="big time-button" data-time="300">
                        5 Minutes
                    </button>
                </li>
                <li>
                    <button class="big time-button" data-time="420">
                        7 Minutes
                    </button>
                </li>
            </ul>
        </div>
        <canvas class="screen off" id="test" style="display: none" width="880" height="695"></canvas>
        <div class="screen off" id="results-screen">
            <div id="result-container">
                <div id="result-type">Statements Acknowledged</div>
                <div id="results">
                    <span id="score_result">0</span>
                </div>
                <div class="result-detail">
                    (You caught approx, <span id="percent_score">0</span>%
                    of the illuminated lights!)
                </div>
            </div>
            <div id="result-container">
                <div id="result-type">Overall Coordination</div>
                <div id="results-lights-acknowledged">
                    <span id="average_accuracy">0</span>
                    <span class="tag">%</span>
                </div>
                <div id="overall-detail">
                    <div id="primary" class="overall-result">
                        Primary <span> 88</span><small>%</small>
                    </div>
                    <div id="secondary" class="overall-result">
                        Secondary <span> 65</span><small>%</small>
                    </div>
                </div>
            </div>
            <div class="bottom">
